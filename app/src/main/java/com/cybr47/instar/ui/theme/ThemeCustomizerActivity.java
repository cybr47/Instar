package com.cybr47.instar.ui.theme;
...
import com.cybr47.instar.mods.ui.theme.IgThemePalette;
import com.cybr47.instar.mods.ui.theme.ThemePreset;
import com.cybr47.instar.mods.ui.theme.ThemePresets;
import com.cybr47.instar.mods.ui.theme.ThemeSettingsHelper;

public class ThemeCustomizerActivity extends AppCompatActivity implements AdvancedColorPickerDialog.Listener {

    private static final String CACHE_NAME = "instar_cache";
    ...
    private void persist() {
        ...
        Intent enabledIntent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF");
        enabledIntent.putExtra("key", KEY_ENABLED);
        enabledIntent.putExtra("value", enabled);
        sendBroadcast(enabledIntent);

        Intent presetIntent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_INT");
        presetIntent.putExtra("key", KEY_PRESET_ID);
        presetIntent.putExtra("value", presetId);
        sendBroadcast(presetIntent);

        Intent paletteIntent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
