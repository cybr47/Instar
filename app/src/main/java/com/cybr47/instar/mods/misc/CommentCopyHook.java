...
public class CommentCopyHook {
    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        try {
            ...
            ModuleLog.line("(Instar | CopyComment): ⚠️ Activity tracker – " + t);
        }
        ...
        if (DexKitCache.isCacheValid()) {
            ...
            if (cachedFmj != null && cachedResolver != null
                ...
                ModuleLog.line("(Instar | CopyComment): ✅ Hooked (cached, new) "
            ...
            if (cachedLongPress != null && !cachedLongPress.isEmpty()) {
                ...
                ModuleLog.line("(Instar | CopyComment): ✅ Hooked (cached, legacy) – "
        ...
        try {
            ...
            ModuleLog.line("(Instar | CopyComment): ⚠️ new-architecture path failed, "
        ...
        try {
            ...
            ModuleLog.line("(Instar | CopyComment): ❌ install – " + t.getMessage());
        }
    }
    ...
    private boolean findAndHookNew(DexKitBridge bridge, ClassLoader classLoader) {
        try {
            ...
            if (fmj == null) {
                ModuleLog.line("(Instar | CopyComment): ❌ Dcq.FmJ-equivalent not found "
            ...
            if (!resolveRepoField(fmj.getDeclaringClass())) {
                ModuleLog.line("(Instar | CopyComment): ❌ repository field not found on "
            ...
            if (resolverMethod == null) {
                ModuleLog.line("(Instar | CopyComment): ❌ resolver method not found among FmJ's callees");
                return false;
            }
            ...
            FeatureStatusTracker.setHooked("CopyComment");
            ModuleLog.line("(Instar | CopyComment): ✅ Hooked " + fmj.getDeclaringClass().getName()
                    + "." + fmj.getName() + " (resolver=" + resolverMethod.getDeclaringClass().getName()
                    + "." + resolverMethod.getName() + ")");
            return true;
        } catch (Throwable t) {
            ModuleLog.line("(Instar | CopyComment): ❌ findAndHookNew – " + t);
            return false;
        }
    }
    ...
    private void findAndHookOld(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        if (found.isEmpty()) {
            ModuleLog.line("(Instar | CopyComment): ❌ legacy onLongPress not found via DexKit either");
            return;
        }
        ...
        for (MethodData md : found) {
            try {
                ...
                XposedBridge.hookMethod(m, LONG_PRESS_HOOK);
                hooked.add(m);
                ModuleLog.line("(Instar | CopyComment): ✅ Hooked (legacy) "
                        + md.getClassName() + ".onLongPress");
            } catch (Throwable t) {
                ModuleLog.line("(Instar | CopyComment): ❌ legacy hook – " + t.getMessage());
            }
        }
    ...
    private static final XC_MethodHook LONG_PRESS_HOOK = new XC_MethodHook() {
        ...
        protected void beforeHookedMethod(MethodHookParam param) {
            ...
            try {
                ...
                ModuleLog.line("(Instar | CopyComment): ❌ legacy hook body – " + t);
            }
        }
    };
    ...
    private static String discoverAndCacheLegacy(Object gestureListener) {
        try {
            ...
            for (Field f1 : gestureListener.getClass().getDeclaredFields()) {
                ...
                for (Field f2 : holder.getClass().getDeclaredFields()) {
                    ...
                    if (found != null) {
                        ...
                        ModuleLog.line("(Instar | CopyComment): cached (legacy) "
            ...
            ModuleLog.line("(Instar | CopyComment): ❌ legacy discover – " + t);
        }
        return null;
    }
    ...
    private static final XC_MethodHook SHOW_MENU_HOOK = new XC_MethodHook() {
        ...
        protected void beforeHookedMethod(MethodHookParam param) {
            ...
            try {
                ...
                ModuleLog.line("(Instar | CopyComment): ❌ hook body – " + t);
            }
        }
    };
    ...
    private static void showCopyPopup(final Context ctx, final String text) {
        MAIN.post(() -> {
            try {
                ...
                ModuleLog.line("(Instar | CopyComment): ❌ Popup – " + t.getMessage());
            }
        });
    }
    ...
    private static void showSelectDialog(final Context ctx, final String text) {
        MAIN.post(() -> {
            try {
                ...
                ModuleLog.line("(Instar | CopyComment): ❌ SelectDialog – " + t.getMessage());
            }
        });
    }
    ...
    private static void copyToClipboard(final Context ctx, final String text) {
        try {
            ...
            ModuleLog.line("(Instar | CopyComment): ❌ Copy – " + t.getMessage());
        }
    }
}
