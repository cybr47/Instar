    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        try {
            ...
            for (MethodData md : showMethods) {
                ...
                ModuleLog.line("(Instar | BuildExpired) ✅ hooked show-popup → "
            ...
            if (!hookedMain) {
                ModuleLog.line("(Instar | BuildExpired) ⚠️ show-popup method not found, falling back to boolean hook only");
            }
            ...
            for (MethodData md : checkMethods) {
                ...
                ModuleLog.line("(Instar | BuildExpired) ✅ hooked snooze-check → "
                        + md.getClassName() + "." + md.getName());
                if (!hookedMain) {
                    FeatureStatusTracker.setHooked("RemoveBuildExpiredPopup");
                }
            ...
            ModuleLog.line("(Instar | BuildExpired) ❌ install: " + t);
        }
    }
}
