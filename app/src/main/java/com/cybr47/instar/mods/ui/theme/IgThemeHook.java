package com.cybr47.instar.mods.ui.theme;
...
public class IgThemeHook {
    ...
    public void install(ClassLoader classLoader) {
        ...
        try {
            ...
            ModuleLog.line("(Instar | Theme): hooks installed enabled=" + FeatureFlags.customThemeEnabled);
        } catch (Throwable t) {
            ModuleLog.line("(Instar | Theme): hook failed", t);
        }
    }
    ...
    private boolean tryHookPhoneWindow(ClassLoader cl, XC_MethodHook statusHook, XC_MethodHook navHook) {
        try {
            ...
            ModuleLog.line("(Instar | Theme): PhoneWindow color hooks installed");
            return true;
        } catch (Throwable ignored) {
            return false;
        }
