...
public class ReelDownloadHook {
    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        if (DexKitCache.isCacheValid()) {
            ...
            if (cached != null) {
                ...
                ModuleLog.line("(Instar | Reel) ✅ hooked: " + hookMethod.getDeclaringClass().getName() + "." + hookMethod.getName());
                return;
            }
        }
        ...
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | Reel) ❌ ClipsOrganicMediaItemViewMoreOptionsController not found");
                return;
            }
            ...
            if (target == null) {
                ModuleLog.line("(Instar | Reel) ❌ hook method (Media, ButtonAdder)V not found");
                return;
            }
            ...
            ModuleLog.line("(Instar | Reel) ❌ install: " + t);
        }
    }
    ...
    private static void installReduceOptionsListPatch(DexKitBridge bridge, ClassLoader classLoader) {
        try {
            ...
            if (downloadOption == null) {
                ModuleLog.line("(Instar | Reel) ❌ DOWNLOAD enum value not found");
                return;
            }
            ...
            XC_MethodHook hook = new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param) {
                    ...
                    try {
                        ...
                        ModuleLog.line("(Instar | Reel) ❌ options-list patch failed: " + t);
                    }
                }
            };
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | Reel) ⚠️ Reduced options-list builder not found");
                return;
            }
            ...
            FeatureStatusTracker.setHooked("ReelDownload");
            ModuleLog.line("(Instar | Reel) ✅ Options-list patch hooked: " +
                    target.getDeclaringClass().getName() + "." + target.getName());

        } catch (Throwable t) {
            ModuleLog.line("(Instar | Reel) ❌ installReduceOptionsListPatch: " + t);
        }
    }
    ...
    private static void installGateHook(DexKitBridge bridge, ClassLoader classLoader,
        ...
        XC_MethodHook hook = new XC_MethodHook() {
            ...
            protected void beforeHookedMethod(MethodHookParam param) {
                ModuleLog.line("(Instar | Reel|DEBUG) gate fired: " + cacheKey + " enabled=" + FeatureFlags.enableReelDownload);
        ...
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | Reel) ⚠️ Gate method not found for config " + configId);
                return;
            }
            ...
            FeatureStatusTracker.setHooked("ReelDownload");
            ModuleLog.line("(Instar | Reel) ✅ Gate unlocked: " +
                    target.getDeclaringClass().getName() + "." + target.getName() + " -> " + forcedResult);

        } catch (Throwable t) {
            ModuleLog.line("(Instar | Reel) ❌ installGateHook(" + cacheKey + "): " + t);
        }
    }
    ...
    private static void onOptionsBuilt(XC_MethodHook.MethodHookParam param) {
        try {
            ...
            if (activityField == null) {
                ModuleLog.line("(Instar | Reel) ❌ no Activity field on controller");
                return;
            }
            ...
            if (buttonAdderMethod == null) {
                ModuleLog.line("(Instar | Reel) ❌ buttonAdderMethod not found");
                return;
            }
            ...
            ModuleLog.line("(Instar | Reel) ❌ onOptionsBuilt: " + t);
        }
    }
