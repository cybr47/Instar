...
public class DownloadSaveService extends Service {
    ...
    private static final String CACHE_PREFS = "instar_cache";
    ...
    private void postDoneNotification(int startId, String text, String mimeType, Uri fileUri) {
        ...
        builder.setContentTitle("Instar")
               .setContentText(text)
               .setSmallIcon(icon)
               .setAutoCancel(true);
    ...
    private void ensureChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel ch = new NotificationChannel(
                    CHANNEL_ID, "Instar Downloads", NotificationManager.IMPORTANCE_LOW);
