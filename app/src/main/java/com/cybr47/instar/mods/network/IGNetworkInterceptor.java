package com.cybr47.instar.mods.network;
...
import com.cybr47.instar.mods.misc.FollowStatusHook;
    ...
    public void handleInterceptor(XC_LoadPackage.LoadPackageParam lpparam) {
        try {
            ...
            if (random_param_1 != null && random_param_2 != null && random_param_3 != null && uriFieldName != null) {
                ...
                ModuleLog.line("(Instar | Interceptor): Could not resolve required classes or fields.");
            }

        } catch (Exception e) {
            ModuleLog.line("(Instar | Interceptor): ❌ " + e.getMessage());
        }
    }
}
