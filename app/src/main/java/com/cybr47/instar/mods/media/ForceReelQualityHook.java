...
public class ForceReelQualityHook {
    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        try {
            ...
            if (videoVersionsGetter == null || heightGetterName == null) {
                ...
                if (videoVersionsGetter == null || heightGetterName == null) {
                    ModuleLog.line("(Instar | ForceReelQuality): ❌ discovery failed");
                    return;
                }
            ...
            XposedBridge.hookMethod(videoVersionsGetter, new XC_MethodHook() {
                ...
                protected void afterHookedMethod(MethodHookParam param) {
                    ...
                    try {
                        ...
                        ModuleLog.line("(Instar | ForceReelQuality): ❌ hook body – " + t);
                    }
                }
            });
            ...
            ModuleLog.line("(Instar | ForceReelQuality): ✅ Hooked " + DICT_CLASS
                    + " (height=" + heightGetterName + ")");
        } catch (Throwable t) {
            ModuleLog.line("(Instar | ForceReelQuality): ❌ install – " + t);
        }
    }
    ...
    private static Method resolveVideoVersionsGetter(DexKitBridge bridge, ClassLoader classLoader) {
        try {
            ...
            ModuleLog.line("(Instar | ForceReelQuality): ❌ resolveVideoVersionsGetter – " + t);
        }
        return null;
    }
    ...
    private static String resolveHeightGetterName(DexKitBridge bridge, ClassLoader classLoader) {
        try {
            ...
            ModuleLog.line("(Instar | ForceReelQuality): ❌ resolveHeightGetterName – " + t);
        }
        return null;
    }
