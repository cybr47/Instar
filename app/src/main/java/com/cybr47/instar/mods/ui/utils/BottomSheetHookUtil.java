package com.cybr47.instar.mods.ui.utils;
...
public class BottomSheetHookUtil {
    ...
    public static void hookBottomSheetNavigator(DexKitBridge bridge) {
        ...
        try {
            ...
            ModuleLog.line("(Instar | BottomSheet): ❌ DexKit exception: " + e.getMessage());
        }
    }
    ...
    private static void hookMethod(Method reflectMethod) {
        ...
        ModuleLog.line("(Instar | BottomSheet): ✅ Hooked: " + reflectMethod.getDeclaringClass().getName() + "." + reflectMethod.getName());
    }
}
