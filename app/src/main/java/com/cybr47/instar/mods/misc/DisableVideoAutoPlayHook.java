...
public class DisableVideoAutoPlayHook {
    private static final String PLAY_DRAWABLE_FIELD = "InstarManualVideoPlayDrawable";
    ...
    public void handleAutoPlayDisable(DexKitBridge bridge) {
        ...
        try {
            ...
            ModuleLog.line("(Instar | AutoPlayDisable): Error: " + e.getMessage());
        }
    }
    ...
    private void findAndHookDynamicMethod(DexKitBridge bridge) {
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | AutoPlayDisable): ❌ No matching methods found.");
                return;
            }
            ...
            ModuleLog.line("(Instar | AutoPlayDisable): ❌ No matching methods with correct signature.");
        } catch (Exception e) {
            ModuleLog.line("(Instar | AutoPlayDisable): ❌ Error during method discovery: " + e.getMessage());
        }
    }
    ...
    private void hookMethod(MethodData method) {
        try {
            ...
            ModuleLog.line("(Instar | AutoPlayDisable): ✅ Hooked (dynamic check): " +
                    method.getClassName() + "." + method.getName());
        } catch (Exception e) {
            ModuleLog.line("(Instar | AutoPlayDisable): ❌ Error hooking method: " + e.getMessage());
        }
    }
    ...
    private void hookManualPlayOverlayLifecycle() {
        ...
        try {
            ...
            ModuleLog.line("(Instar | AutoPlayDisable): Hooked manual play overlay lifecycle.");
        } catch (Throwable t) {
            ModuleLog.line("(Instar | AutoPlayDisable): Error hooking play overlay lifecycle: " + t.getMessage());
        }
    }
