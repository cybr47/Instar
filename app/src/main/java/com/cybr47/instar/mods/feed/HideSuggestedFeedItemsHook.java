package com.cybr47.instar.mods.feed;
...
public class HideSuggestedFeedItemsHook {
    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        if (DexKitCache.isCacheValid()) {
            ...
            if (cached != null) {
                try {
                    ...
                    ModuleLog.line("(Instar | HideSuggested): ⚠️ Cache hook failed: " + t.getMessage());
                }
            }
        }
        ...
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | HideSuggested): ❌ FeedItem parser not found.");
                return;
            }
            ...
            markHookedForEnabledFlags();
            ModuleLog.line("(Instar | HideSuggested): ✅ Hooked: " + targetClass);

        } catch (Throwable t) {
            ModuleLog.line("(Instar | HideSuggested): ❌ Exception: " + t.getMessage());
        }
    }
