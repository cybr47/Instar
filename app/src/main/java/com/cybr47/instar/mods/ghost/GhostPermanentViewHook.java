...
public class GhostPermanentViewHook {
    ...
    public void install(DexKitBridge bridge, ClassLoader classLoader) {
        ...
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | ViewOnceMedia) ❌ unsafeParseFromJson not found");
                return;
            }
            ...
            if (target == null) {
                ...
                try {
                    ...
                    ModuleLog.line("(Instar | ViewOnceMedia) ❌ Could not resolve method: " + t);
                    return;
                }
            }

            ModuleLog.line("(Instar | ViewOnceMedia) ✅ hooking "
            ...
            FeatureStatusTracker.setHooked("PermanentViewMode");
            ModuleLog.line("(Instar | ViewOnceMedia) ✅ hooked");

        } catch (Throwable t) {
            ModuleLog.line("(Instar | ViewOnceMedia) ❌ " + t);
        }
    }
