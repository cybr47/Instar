package com.cybr47.instar.mods.location;
...
public class LocationPickerActivity extends AppCompatActivity {
    ...
    private void persistCoords(double lat, double lng) {
        getSharedPreferences("instar_prefs", MODE_PRIVATE).edit()
                .putString("spoofLat", String.valueOf(lat))
                .putString("spoofLng", String.valueOf(lng))
                .apply();
        getSharedPreferences("instar_cache", MODE_PRIVATE).edit()
                .putString("spoofLat", String.valueOf(lat))
                .putString("spoofLng", String.valueOf(lng))
                .apply();

        Intent latIntent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
        ...
        Intent lngIntent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
