    ...
    public void handleSeenBlock(DexKitBridge bridge) {
        ...
        if (DexKitCache.isCacheValid()) {
            ...
            if (cached != null) {
                ...
                ModuleLog.line("(Instar | GhostModeSeen): ✅ Hooked: " + cached.getDeclaringClass().getName() + "." + cached.getName());
        ...
        try {
            ...
            if (methods.isEmpty()) {
                ModuleLog.line("(Instar | GhostModeSeen): ❌ No methods found using 'mark_thread_seen-'");
                return;
            }
            ...
            for (MethodData method : methods) {
                ...
                if (Modifier.isStatic(modifiers)
                    ...
                    try {
                        ...
                        ModuleLog.line("(Instar | GhostModeSeen): ✅ Hooked: " +
                                method.getClassName() + "." + method.getName());
                        FeatureStatusTracker.setHooked("GhostSeen");
                        return;

                    } catch (Throwable e) {
                        ModuleLog.line("(Instar | GhostModeSeen): ❌ Hook error: " + e.getMessage());
                    }
                }
            }

        } catch (Throwable e) {
            ModuleLog.line("(Instar | GhostModeSeen): ❌ DexKit exception: " + e.getMessage());
        }
    }
