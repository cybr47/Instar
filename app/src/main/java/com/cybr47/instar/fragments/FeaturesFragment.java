package com.cybr47.instar.fragments;
...
public class FeaturesFragment extends Fragment {
    ...
    private final BroadcastReceiver prefsReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("com.cybr47.instar.ACTION_SEND_PREFS".equals(intent.getAction())) {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
            ...
            try (InputStream is = requireContext().getContentResolver().openInputStream(uri);
                ...
                while (keys.hasNext()) {
                    ...
                    if (val instanceof Boolean) {
                        ...
                        Intent intent = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF");
        ...
        locationPickerLauncher = registerForActivityResult(
                new ActivityResultContracts.StartActivityForResult(), result -> {
                    ...
                    Intent b1 = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
                    b1.putExtra("key", "spoofLat");
                    b1.putExtra("value", String.valueOf(lat));
                    requireContext().sendBroadcast(b1);

                    Intent b2 = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
        ...
        dirPickerLauncher = registerForActivityResult(new ActivityResultContracts.OpenDocumentTree(), uri -> {
            if (uri != null) {
                ...
                Intent intentUri = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
                intentUri.putExtra("key", "downloaderCustomUri");
                intentUri.putExtra("value", uriString);
                requireContext().sendBroadcast(intentUri);

                Intent intentPath = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_STRING");
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        localCache = requireContext().getSharedPreferences("instar_cache", Context.MODE_PRIVATE);
    ...
    private void loadDistractionMenu() {
        ...
        List<String> distractionKeys = Arrays.asList(
                ...
                "hideNotesTray", "hideStoriesTray", "disableReelsScrolling"
        );
        ...
        defs.add(Arrays.asList(
                ...
                createSwitchLockedByExtreme(R.drawable.ic_notification, "#30D158", getString(R.string.ig_dialog_distraction_hide_notes_tray), "hideNotesTray"),
                createSwitchLockedByExtreme(R.drawable.ic_story_ring, "#30D158", getString(R.string.ig_dialog_distraction_hide_stories_tray), "hideStoriesTray"),
                createSwitchLockedByExtreme(R.drawable.ic_movie, "#30D158", getString(R.string.ig_dialog_distraction_disable_reels_scrolling), "disableReelsScrolling")
        ));
    ...
    private void loadMiscMenu() {
        ...
        defs.add(Arrays.asList(
                createMasterSwitch(getString(R.string.ig_dialog_enable_disable_all), Arrays.asList(
                        "disableStoryFlipping", "disableVideoAutoPlay", "spoofLastSeen", "disableRepost", "hideReelsUfiCounts", "enableProfileQuickActions", "showFollowerToast",
                ...
                createSwitch(R.drawable.ic_heart, "#BF5AF2", getString(R.string.ig_dialog_misc_hide_reels_ufi_counts), "hideReelsUfiCounts"),
                createSwitch(R.drawable.ic_content_copy, "#BF5AF2", getString(R.string.ig_dialog_misc_profile_quick_actions), "enableProfileQuickActions"),
    ...
    private void pickQuality(int current) {
        ...
        new MaterialAlertDialogBuilder(requireContext())
                ...
                .setSingleChoiceItems(labels, sel, (dialog, which) -> {
                    ...
                    Intent b = new Intent("com.cybr47.instar.ACTION_UPDATE_PREF_INT");
    ...
    private void makeLocalCacheWorldReadable() {
        try {
            java.io.File prefsFile = new java.io.File(
                    requireContext().getApplicationInfo().dataDir + "/shared_prefs/instar_cache.xml");
    ...
    private void backupSettings() {
        try {
            ...
            exportIntent.setComponent(new ComponentName(requireContext(), "com.cybr47.instar.mods.devops.config.JsonExportActivity"));
    ...
    private void exportDevConfig() {
        BroadcastReceiver configReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                Intent exportIntent = new Intent();
                exportIntent.setComponent(new ComponentName(activity, "com.cybr47.instar.mods.devops.config.JsonExportActivity"));
                exportIntent.putExtra("json_content", json);
                startActivity(exportIntent);
            }
        };
        IntentFilter filter = new IntentFilter("com.cybr47.instar.ACTION_SEND_CONFIG");
        ...
        Intent request = new Intent("com.cybr47.instar.ACTION_EXPORT_CONFIG");
        ...
        new AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton(getString(R.string.ig_dialog_yes), (dialog, which) -> {
                    try (InputStream is = requireContext().getAssets().open("default_mc_overrides.json");
                        ...
                        Intent broadcast = new Intent("com.cybr47.instar.ACTION_IMPORT_CONFIG");
    ...
    private void showAboutDialog() {
        new AlertDialog.Builder(requireContext())
                .setTitle("Instar")
                .setMessage("Instar by cybr47\nBased on InstaEclipse and Piko\n\nGitHub: https://github.com/cybr47/Instar")
    ...
    public void onResume() {
        super.onResume();
        IntentFilter filter = new IntentFilter("com.cybr47.instar.ACTION_SEND_PREFS");
        if (Build.VERSION.SDK_INT >= 33) {
        ...
        requireContext().sendBroadcast(new Intent("com.cybr47.instar.ACTION_REQUEST_PREFS"));
    }
