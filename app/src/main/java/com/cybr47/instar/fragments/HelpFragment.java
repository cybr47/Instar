...
public class HelpFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        githubCard.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/cybr47/Instar"));
            startActivity(intent);
        });

        // Set the click listener for the Telegram button
        telegramCard.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/cybr47/Instar/issues"));
            startActivity(intent);
        });
