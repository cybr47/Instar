...
import com.cybr47.instar.utils.core.Contributor;
...
public class HomeFragment extends Fragment {
    ...
    private void bindPackageActions(PackageManager pm, String pkg) {
        ...
        try {
            android.content.pm.PackageInfo info = pm.getPackageInfo(pkg, 0);
            String versionName = info.versionName;
            boolean unsupported = InstagramCompatibility.isAboveCeiling(
                    versionName, info.getLongVersionCode());
            ...
            if (unsupported) {
                fullText += "\n" + getString(R.string.instagram_above_instar_ceiling,
                        InstagramCompatibility.MAX_VERSION_NAME);
                instagramStatusCard.setCardBackgroundColor(getResources().getColor(R.color.dark_red));
                instagramLogo.setImageResource(R.drawable.ic_cancel);
            }
