...
public class SettingsManager {
    private static final String PREF_NAME = "instar_prefs";
    ...
    public static void saveAllFlags() {
        ...
        editor.putBoolean("hideNotesTray", FeatureFlags.hideNotesTray);
        editor.putBoolean("hideStoriesTray", FeatureFlags.hideStoriesTray);
        editor.putBoolean("disableReelsScrolling", FeatureFlags.disableReelsScrolling);
        ...
        editor.putBoolean("hideReelsUfiCounts", FeatureFlags.hideReelsUfiCounts);
        editor.putBoolean("enableProfileQuickActions", FeatureFlags.enableProfileQuickActions);
    ...
    public static void loadAllFlags(Context context) {
        ...
        FeatureFlags.hideNotesTray = prefs.getBoolean("hideNotesTray", false);
        FeatureFlags.hideStoriesTray = prefs.getBoolean("hideStoriesTray", false);
        FeatureFlags.disableReelsScrolling = prefs.getBoolean("disableReelsScrolling", false);
        ...
        FeatureFlags.hideReelsUfiCounts = prefs.getBoolean("hideReelsUfiCounts", false);
        FeatureFlags.enableProfileQuickActions = prefs.getBoolean("enableProfileQuickActions", false);
