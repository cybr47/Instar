package com.cybr47.instar.utils.backup;
...
public class SettingsBackupManager {
    ...
    public static String toJson() throws JSONException {
        ...
        s.put("disableReelsScrolling",   FeatureFlags.disableReelsScrolling);
        ...
        s.put("hideReelsUfiCounts",      FeatureFlags.hideReelsUfiCounts);
        s.put("enableProfileQuickActions", FeatureFlags.enableProfileQuickActions);
    ...
    public static void fromJson(String json) throws JSONException {
        ...
        if (s.has("disableReelsScrolling"))  FeatureFlags.disableReelsScrolling  = s.getBoolean("disableReelsScrolling");
        ...
        if (s.has("hideReelsUfiCounts"))     FeatureFlags.hideReelsUfiCounts     = s.getBoolean("hideReelsUfiCounts");
        if (s.has("enableProfileQuickActions")) FeatureFlags.enableProfileQuickActions = s.getBoolean("enableProfileQuickActions");
