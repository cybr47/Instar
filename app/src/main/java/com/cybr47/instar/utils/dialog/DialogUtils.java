package com.cybr47.instar.utils.dialog;
...
import com.cybr47.instar.utils.core.ModuleActivityLauncher;
import com.cybr47.instar.utils.core.SettingsManager;
import com.cybr47.instar.utils.feature.FeatureFlags;
import com.cybr47.instar.utils.ghost.GhostModeUtils;
...
public class DialogUtils {
    ...
    private static void restartApp(Context context) {
        try {
            ...
            String packageName = context.getPackageName();
            ModuleLog.line("Instar: Restart failed for " + packageName + " - " + e.getMessage());
    ...
    private static void clearAppCache(Context context) {
        try {
            ...
            if (cacheDir != null && cacheDir.isDirectory()) {
                ...
                ModuleLog.line("Instar: Cache cleared for " + context.getPackageName());
            } else {
                ModuleLog.line("Instar: Cache directory not found for " + context.getPackageName());
            }
        } catch (Exception e) {
            ModuleLog.line("Instar: Failed to clear cache for " + context.getPackageName() + " - " + e.getMessage());
        }
    }
    ...
    private static void showDevOptions(Context context) {
        ...
        layout.addView(createActionRow(context, R.drawable.ic_download, I18n.t(context, R.string.ig_dialog_dev_import), "#30D158", v -> {
            ...
            if (instagramActivity != null && !instagramActivity.isFinishing()) {
                ...
                importIntent.setComponent(new ComponentName("com.cybr47.instar", "com.cybr47.instar.mods.devops.config.JsonImportActivity"));
                ...
                try {
                    ...
                    ModuleLog.line("Instar | ❌ Failed to start JsonImportActivity: " + e.getMessage());
        ...
        layout.addView(createActionRow(context, R.drawable.ic_upload, I18n.t(context, R.string.ig_dialog_dev_export), "#0A84FF", v -> {
            ...
            if (instagramActivity != null && !instagramActivity.isFinishing()) {
                try {
                    ...
                    exportIntent.setComponent(new ComponentName("com.cybr47.instar", "com.cybr47.instar.mods.devops.config.JsonExportActivity"));
    ...
    private static void showDistractionOptions(Context context) {
        ...
        ToggleRow hideNotesTraySwitch = createSwitch(context, R.drawable.ic_notification, "#30D158", I18n.t(context, R.string.ig_dialog_distraction_hide_notes_tray), FeatureFlags.hideNotesTray);
        ToggleRow hideStoriesTraySwitch = createSwitch(context, R.drawable.ic_story_ring, "#30D158", I18n.t(context, R.string.ig_dialog_distraction_hide_stories_tray), FeatureFlags.hideStoriesTray);
        ToggleRow disableReelsScrollingSwitch = createSwitch(context, R.drawable.ic_movie, "#30D158", I18n.t(context, R.string.ig_dialog_distraction_disable_reels_scrolling), FeatureFlags.disableReelsScrolling);

        ToggleRow[] switches = new ToggleRow[]{disableStoriesSwitch, disableFeedSwitch, disableReelsSwitch, onlyInDMSwitch, disableExploreSwitch, disableCommentsSwitch, hideNotesTraySwitch, hideStoriesTraySwitch, disableReelsScrollingSwitch};
        ...
        extremeModeSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                ...
                builder.setPositiveButton(I18n.t(context, R.string.ig_dialog_yes), (dialog, which) -> {
                    ...
                    FeatureFlags.hideNotesTray = hideNotesTraySwitch.isChecked();
                    FeatureFlags.hideStoriesTray = hideStoriesTraySwitch.isChecked();
                    FeatureFlags.disableReelsScrolling = disableReelsScrollingSwitch.isChecked();
                    SettingsManager.saveAllFlags();
        ...
        // All other switches
        for (ToggleRow s : new ToggleRow[]{disableStoriesSwitch, disableFeedSwitch, disableExploreSwitch, disableCommentsSwitch, hideNotesTraySwitch, hideStoriesTraySwitch, disableReelsScrollingSwitch}) {
    ...
    private static void showMiscOptions(Context context) {
        ...
        ToggleRow[] switches = new ToggleRow[]{
                ...
                createSwitch(context, R.drawable.ic_heart, "#BF5AF2", I18n.t(context, R.string.ig_dialog_misc_hide_reels_ufi_counts), FeatureFlags.hideReelsUfiCounts),
                createSwitch(context, R.drawable.ic_content_copy, "#BF5AF2", I18n.t(context, R.string.ig_dialog_misc_profile_quick_actions), FeatureFlags.enableProfileQuickActions),
            ...
            switches[i].setOnCheckedChangeListener((buttonView, isChecked) -> {
                ...
                switch (index) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        FeatureFlags.hideReelsUfiCounts = isChecked;
                        break;
                    case 4:
                        FeatureFlags.enableProfileQuickActions = isChecked;
                        break;
                    case 5:
        ...
        layout.addView(createActionRow(context, R.drawable.ic_pin,
                I18n.t(context, R.string.ig_dialog_location_pick) + " — " + coordLabel, "#FFD60A", v -> {
                    ...
                    if (ModuleActivityLauncher.launch(context,
                            "com.cybr47.instar.mods.location.LocationPickerActivity", extras)) {
    ...
    private static void showThemeOptions(Context context) {
        ...
        themeSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            SettingsManager.saveAllFlags();
            com.cybr47.instar.mods.ui.theme.IgThemeEngine.invalidate();
            com.cybr47.instar.mods.ui.theme.IgThemeHook.refreshCurrentActivity();
        });
        ...
        layout.addView(createActionRow(context, R.drawable.ic_palette,
                I18n.t(context, R.string.theme_customize), "#FF2D55", v -> {
                    if (ModuleActivityLauncher.launch(context,
                            "com.cybr47.instar.ui.theme.ThemeCustomizerActivity", null)) {
                        if (currentDialog != null) {
                            try { currentDialog.dismiss(); } catch (Exception ignored) {}
                            currentDialog = null;
                        }
    ...
    private static void showDownloaderSettings(Context context) {
        ...
        // so "/storage/emulated/0/Download/Instar" → "Download/Instar"
    ...
    private static void showBackupRestoreOptions(Context context) {
        ...
        layout.addView(createActionRow(context, R.drawable.ic_save, I18n.t(context, R.string.ig_dialog_backup_settings), "#30D158", v -> {
            try {
                ...
                if (instagramActivity != null && !instagramActivity.isFinishing()) {
                    Intent exportIntent = new Intent();
                    exportIntent.setComponent(new ComponentName("com.cybr47.instar",
                            "com.cybr47.instar.mods.devops.config.JsonExportActivity"));
                    exportIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                    exportIntent.putExtra("json_content", json);
        ...
        layout.addView(createActionRow(context, R.drawable.ic_folder, I18n.t(context, R.string.ig_dialog_restore_settings), "#0A84FF", v -> {
            ...
            if (instagramActivity != null && !instagramActivity.isFinishing()) {
                ...
                importIntent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                importIntent.putExtra("target_package", context.getPackageName());
                importIntent.putExtra("broadcast_action", "com.cybr47.instar.ACTION_RESTORE_SETTINGS");
                instagramActivity.startActivity(importIntent);
            } else {
                showSimpleDialog(context, I18n.t(context, R.string.ig_dialog_error), I18n.t(context, R.string.ig_dialog_instagram_not_ready));
            }
    ...
    private static void showAboutDialog(Context context) {
        ...
        View githubBtn = createActionRow(context, R.drawable.ic_github_logo, I18n.t(context, R.string.ig_dialog_about_github), "#8E8E93", v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, android.net.Uri.parse("https://github.com/cybr47/Instar"));
        ...
        View tgBtn = createActionRow(context, R.drawable.ic_telegram_logo, I18n.t(context, R.string.ig_dialog_about_telegram), "#29B6F6", v -> {
            Intent i = new Intent(Intent.ACTION_VIEW, android.net.Uri.parse("https://github.com/cybr47/Instar/issues"));
            i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(i);
        });
    ...
    private static void showClearCacheSection(Context context) {
        ...
        layout.addView(createActionRow(context, R.drawable.ic_delete, I18n.t(context, R.string.ig_dialog_clear_cache_now), "#FF9F0A", v -> {
            com.cybr47.instar.utils.core.DexKitCache.clearCache();
            restartApp(context);
        }));
