package com.cybr47.instar.utils.log;
 ...
 * ring buffer so the message shows up in Instar's in-app log viewer, not just adb logcat.
 *
...
public final class ModuleLog {
    ...
    private static final String TAG = "Instar";
