package com.cybr47.instar.utils.feature;
...
public class FeatureManager {
    ...
    public static void refreshFeatureStatus() {
        ...
        if (FeatureFlags.disableRepost) {
            FeatureStatusTracker.setEnabled("HideRepostButton", R.string.ig_dialog_misc_disable_repost);
        } else {
            FeatureStatusTracker.setDisabled("HideRepostButton");
        }

        if (FeatureFlags.hideReelsUfiCounts) {
            FeatureStatusTracker.setEnabled("HideReelsUfiCounts", R.string.ig_dialog_misc_hide_reels_ufi_counts);
        } else {
            FeatureStatusTracker.setDisabled("HideReelsUfiCounts");
        }

        if (FeatureFlags.enableProfileQuickActions) {
            FeatureStatusTracker.setEnabled("ProfileQuickActions", R.string.ig_dialog_misc_profile_quick_actions);
        } else {
            FeatureStatusTracker.setDisabled("ProfileQuickActions");
        }

        if (FeatureFlags.hideNotesTray) {
            FeatureStatusTracker.setEnabled("HideNotesTray", R.string.ig_dialog_distraction_hide_notes_tray);
        } else {
            FeatureStatusTracker.setDisabled("HideNotesTray");
        }

        if (FeatureFlags.hideStoriesTray) {
            FeatureStatusTracker.setEnabled("HideStoriesTray", R.string.ig_dialog_distraction_hide_stories_tray);
        } else {
            FeatureStatusTracker.setDisabled("HideStoriesTray");
        }

        if (FeatureFlags.disableReelsScrolling) {
            FeatureStatusTracker.setEnabled("DisableReelsScrolling", R.string.ig_dialog_distraction_disable_reels_scrolling);
        } else {
            FeatureStatusTracker.setDisabled("DisableReelsScrolling");
        }
    }
}
